...
export const billSchema = z.object({
  ...
  articles: positiveIntegerSchema('Number of Articles'),
  ...
  volumetricWeight: nonNegativeNumberSchema('Volumetric Weight'),
  chargeableWeight: nonNegativeNumberSchema('Chargeable Weight'),
  ...
  grandTotal: nonNegativeNumberSchema('Grand Total'),
