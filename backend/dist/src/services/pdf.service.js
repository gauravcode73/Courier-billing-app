...
class PdfService {
    ...
    async generateInlineMockTemplate() {
        ...
        const drawRect = (x, y, width, height, color = (0, pdf_lib_1.rgb)(0.95, 0.95, 0.95)) => {
            page.drawRectangle({
                x,
                y,
                width,
        ...
        // Header
        drawRect(20, 750, 555, 75, (0, pdf_lib_1.rgb)(0.9, 0.93, 0.98));
        ...
        drawRect(350, 200, 225, 100, (0, pdf_lib_1.rgb)(0.98, 0.9, 0.9));
        ...
        drawRect(20, 20, 555, 60, (0, pdf_lib_1.rgb)(0.9, 0.98, 0.9));
    ...
    splitAddress(address) {
        ...
        if (splitIdx === -1)
            splitIdx = address.lastIndexOf(',', mid);
        if (splitIdx === -1)
            splitIdx = mid;
